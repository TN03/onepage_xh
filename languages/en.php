...
$plugin_tx['onepage']['tab_class']="CSS class";
$plugin_tx['onepage']['tab_save']="Save";

$plugin_tx['onepage']['alt_logo']="Yin and Yang";
$plugin_tx['onepage']['alt_toplink']="Scroll to top";

$plugin_tx['onepage']['cf_admin_template']="The template for the edit mode. Leave empty to use the normal template.";
$plugin_tx['onepage']['cf_url_numeric']="Whether to use numeric URLs for the page sections.";
